...
gzip входит в обычную сборку libchttpx. zlib является стандартной зависимостью библиотеки, поэтому отдельного режима сборки и специального build-флага для compression нет.
